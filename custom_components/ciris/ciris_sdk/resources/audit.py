...
class AuditResource:
    ...
    def query_iter(
        ...
        *,
        ...
        return PageIterator(
            fetch_func=self.query, initial_params=params, item_class=dict
        )

    async def get_entry(
        self, entry_id: str, *, verify: bool = False
    ) -> AuditEntryDetailResponse:
        ...
        data = await self._transport.request(
            "GET", f"/v1/audit/entries/{entry_id}", params=params
        )
    ...
    async def export(
        self, format: str = "jsonl", start_date: Optional[datetime] = None
    ) -> AuditExportResponse:
